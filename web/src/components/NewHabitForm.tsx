...
export function NewHabitForm() {
  ...
  function handleToggleWeekDay(weekDay: number) {
    if (weekDays.includes(weekDay)) {
      const newWeekDaysRemoving = weekDays.filter(day => day !== weekDay)
      setWeekDays(newWeekDaysRemoving)
    } else {
      const newWeekDaysAdding = [...weekDays, weekDay]
      setWeekDays(newWeekDaysAdding)
    }
  }
